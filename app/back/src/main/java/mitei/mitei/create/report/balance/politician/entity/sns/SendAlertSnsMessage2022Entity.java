...
/**
 * send_alert_sns_message_2022接続用Entity
 */
@Entity
@Table(name = "send_alert_sns_message_2022")
public class SendAlertSnsMessage2022Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
