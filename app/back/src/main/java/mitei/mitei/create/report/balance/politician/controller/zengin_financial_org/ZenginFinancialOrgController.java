...
import mitei.mitei.create.report.balance.politician.service.zengin_financial_org.ZenginFinancialOrgService;

/**
 * 各種Pay操作Controller
 */
@Controller
@RequestMapping("/zengin-financial-org")
public class ZenginFinancialOrgController extends AbstractTemplateCheckController {
