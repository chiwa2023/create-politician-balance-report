 ...
 */
public interface SnsDmSetteingMockSample2Repository  extends JpaRepository<SnsDmSettingMockSample2Entity, Long>{
     ...
     * @return SNS接続情報
     */
    Optional<SnsDmSettingMockSample2Entity> findByLoginUserCodeAndSaishinKbn(Integer loginUserCode,Integer saishinKbn);
