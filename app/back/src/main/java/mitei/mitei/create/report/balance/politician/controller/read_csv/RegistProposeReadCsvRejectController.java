...
public class RegistProposeReadCsvRejectController extends AbstractTemplateCheckController {
    ...
    /** テーブル履歴設定Logic */
    @Autowired
    private RegistProposeReadCsvRejectControllerWorksBand workBandController;
    ...
    public ResponseEntity<TemplateFrameworkResultDto> practice(
        ...
        try {
             ...
             * ここに固有のビジネス処理を記載する
             */
            return ResponseEntity.ok(workBandController.wakeBusiness(registProposeCsvReadRemplateCapsuleDto));
