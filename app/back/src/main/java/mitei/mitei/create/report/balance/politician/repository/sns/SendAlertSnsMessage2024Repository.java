...
public interface SendAlertSnsMessage2024Repository  extends JpaRepository<SendAlertSnsMessage2024Entity, Long>{
     ...
     */
    List<SendAlertSnsMessage2024Entity> findBySaishinKbnAndSendDatetimeBeforeOrderBySendAlertSnsMessageId(Integer saishinKbn,LocalDateTime sendDatetime);
    
    List<SendAlertSnsMessage2024Entity> findBySaishinKbnAndSendAlertSnsMessageCodeOrderBySendAlertSnsMessageId(Integer saishinKbn,Integer messageCode);
