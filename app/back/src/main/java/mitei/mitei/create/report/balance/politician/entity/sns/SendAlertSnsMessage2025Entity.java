...
/**
 * send_alert_sns_message_2025接続用Entity
 */
@Entity
@Table(name = "send_alert_sns_message_2025")
public class SendAlertSnsMessage2025Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
