...
public class BalancesheetOutcome2025Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
     ...
     * 職業または団体名称を設定する
     *
     * @param professionOrgnizationName 職業または団体名称
     */
    ...
    /**
     * 領収書をちょうしがたかったもの区分を取得する
     *
     * @return 領収書をちょうしがたかったもの区分
     */
    ...
    /**
     * 領収書をちょうしがたかったもの区分を設定する
     *
     * @param notCollectReciptKbn 領収書をちょうしがたかったもの区分
     */
