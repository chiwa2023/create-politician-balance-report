...
/**
 * balancesheet_outcome_2025接続用Entity
 */
@Entity
@Table(name = "balancesheet_outcome_2025")
public class BalancesheetOutcome2025Entity implements Serializable { // NOPMD DataClass
    ...
    /** 領収書を徴しがたかったもの */
    private Boolean notCollectReciptKbn = BOOLEAN_INIT;
    ...
    /** 支出項目同一識別コード */
    private Long balancesheetOutcomeCode = LONG_INIT;
     ...
     * 支出項目同一識別コードを設定する
     *
     * @param balancesheetOutcomeCode 支出項目同一識別コード
     */
    ...
    private Long balancesheetOutcomeId = LONG_INIT;
     ...
     * 支出項目Idを設定する
     *
     * @param balancesheetOutcomeId 支出項目Id
     */
    ...
    /** 支出大項目 */
    private String categorizeGroup = STRING_INIT;
    ...
    /** 交付金に係る支出 */
    private Boolean isExpendituresRelatedGrants = BOOLEAN_INIT;
