 ...
 */
@Component
public class CreateBalancesheetOutcomeByCsvLogic {
     ...
     */
    public BalancesheetOutcome2025Entity practice(final List<CsvCellDto> line, final String[] listPointer) // NOPMD
        ...
        BalancesheetOutcome2025Entity outcomeEntity = new BalancesheetOutcome2025Entity();
        ...
        for (int index = 0; index < max; index++) {
            ...
            switch (action) {
                ...
                // 取引金額収入は支出項目では不要
                //case INCOME_AMOUNT:
                //    outcomeEntity.setAmount(Long.parseLong(line.get(index).getData()));
                //    break;
                ...
                case ACCURAL_DATE:
                    ...
                    outcomeEntity.setAccrualDate(LocalDate.parse(this.convertDateText(line.get(index).getData())));
                    break;

                // 摘要
                case DIGEST:
                    outcomeEntity.setReferDigest(line.get(index).getData());
                    break;
