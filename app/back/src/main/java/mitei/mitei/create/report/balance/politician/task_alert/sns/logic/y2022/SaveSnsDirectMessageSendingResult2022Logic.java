...
/**
 * SNSダイレクトメッセージ送信結果を保存する(2022年)
 */
@Component
public class SaveSnsDirectMessageSendingResult2022Logic {
    ...
    public SendSnsDirectMessageAllPlanResultDto practice(final List<SendSnsDirectMessageResultDto> listResult) {
        ...
        List<SendAlertSnsMessage2022Entity> listUpdate = new ArrayList<>();
        List<SendAlertSnsMessage2022Entity> listInsert = new ArrayList<>();

        SendAlertSnsMessage2022Entity entity;
        SendAlertSnsMessage2022Entity entityPlan;
        ...
        sendAlertSnsMessage2022Repository.saveAll(listUpdate);
        sendAlertSnsMessage2022Repository.saveAll(listInsert);
     ...
     */
    private SendAlertSnsMessage2022Entity getEntityById(final Long entityId) {

        return sendAlertSnsMessage2022Repository.findById(entityId).get();
    }

    
    private CheckPrivilegeDto createPriviledgeDto(final SendAlertSnsMessage2022Entity entity) {
     ...
     */
    private SendAlertSnsMessage2022Entity createSedingPlanEntity(final Boolean isSuccess,
            final SendAlertSnsMessage2022Entity entity,final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        SendAlertSnsMessage2022Entity planEntity = new SendAlertSnsMessage2022Entity();
