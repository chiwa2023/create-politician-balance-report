...
/**
 * sns_dm_setting_mock_sample1接続用Entity
 */
@Entity
@Table(name = "sns_dm_setting_mock_sample1")
public class SnsDmSettingMockSample1Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    /** Serialize id */
    ...
    @Column(name = "mock_sample1_id")
    private Long mockSample1Id = INIT_Long;
     ...
     * @return 項目名称取得Id
     */
    public Long getMockSample1Id() {
        return mockSample1Id;
    }

    /**
     * 項目名称取得Idを設定する
     *
     * @param mockSample1Id 項目名称取得Id
     */
    public void setMockSample1Id(final Long mockSample1Id) {
        this.mockSample1Id = mockSample1Id;
    }

    /** 項目名称取得同一識別コード */
    @Column(name = "mock_sample1_code")
    private Integer mockSample1Code = INIT_Integer;
     ...
     */
    public Integer getMockSample1Code() {
        return mockSample1Code;
    }

    /**
     * 項目名称取得同一識別コードを設定する
     *
     * @param mockSample1Code 項目名称取得同一識別コード
     */
    public void setMockSample1Code(final Integer mockSample1Code) {
        this.mockSample1Code = mockSample1Code;
    }
    ...
    private String passcode = INIT_String;
