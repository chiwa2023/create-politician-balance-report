...
import mitei.mitei.create.report.balance.politician.service.CheckPrivilegeService;
import mitei.mitei.create.report.balance.politician.service.CheckSecurityService;
import mitei.mitei.create.report.balance.politician.service.CheckTransactionService;
...
public class AbstractTemplateCheckController {
     ...
     * @throws DuplicateKeyException   排他制御例外
    ...
    protected int allCheck( // CHECKSTYLE:OFF
            ...
            throws SecurityException, DuplicateKeyException, AuthenticationException { // NOPMD
