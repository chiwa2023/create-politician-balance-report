CREATE TABLE `sns_dm_setting_mock_sample2` (
  `mock_sample2_id` bigint NOT NULL AUTO_INCREMENT COMMENT '項目名称取得Id',
  `mock_sample2_code` int DEFAULT NULL COMMENT '項目名称取得同一識別コード',
  ...
  `access_key1` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'アクセスキー1',
  `access_key2` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'アクセスキー2',
  ...
  PRIMARY KEY (`mock_sample2_id`)
) ENGINE=InnoDB AUTO_INCREMENT=846 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
