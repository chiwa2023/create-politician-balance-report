...
/**
 * SaveSnsDirectMessageSendingResult2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SaveSnsDirectMessageSendingResult2025LogicTest {
    // CHECKSTYLE:OFF
    
    /** テスト対象 */
    @Autowired
    private SaveSnsDirectMessageSendingResult2025Logic saveSnsDirectMessageSendingResult2025Logic;
    ...
    @Test
    @Transactional
    @Sql("save_alert_sns_message_2025.sql")
    void testPractice() { // NOPMD
        ...
        SendSnsDirectMessageAllPlanResultDto resultDto01 = saveSnsDirectMessageSendingResult2025Logic
        ...
        List<SendAlertSnsMessage2025Entity> list01 = sendAlertSnsMessage2025Repository
        ...
        SendSnsDirectMessageAllPlanResultDto resultDto02 = saveSnsDirectMessageSendingResult2025Logic
        ...
        // 再送信2回目
        List<SendAlertSnsMessage2025Entity> list02 = sendAlertSnsMessage2025Repository
                .findBySaishinKbnAndSendAlertSnsMessageCodeOrderBySendAlertSnsMessageId(saishin, code);
        ...
        SendSnsDirectMessageAllPlanResultDto resultDto03 = saveSnsDirectMessageSendingResult2025Logic
        ...
        // 再送信3回目
        List<SendAlertSnsMessage2025Entity> list03 = sendAlertSnsMessage2025Repository
                .findBySaishinKbnAndSendAlertSnsMessageCodeOrderBySendAlertSnsMessageId(saishin, code);
        ...
        SendSnsDirectMessageAllPlanResultDto resultDto04 = saveSnsDirectMessageSendingResult2025Logic
        ...
        // 再送信4回目
        List<SendAlertSnsMessage2025Entity> list04 = sendAlertSnsMessage2025Repository
                .findBySaishinKbnAndSendAlertSnsMessageCodeOrderBySendAlertSnsMessageId(saishin, code);
        assertThat(list04.size()).isEqualTo(1);
        SendAlertSnsMessage2025Entity entity04 = list04.get(0);
        ...
        SendSnsDirectMessageAllPlanResultDto resultDto05 = saveSnsDirectMessageSendingResult2025Logic
        ...
        // 再送信5回目
        List<SendAlertSnsMessage2025Entity> list05 = sendAlertSnsMessage2025Repository
                .findBySaishinKbnAndSendAlertSnsMessageCodeOrderBySendAlertSnsMessageId(saishin, code);
        assertThat(list05.size()).isEqualTo(1);
        SendAlertSnsMessage2025Entity entity05 = list05.get(0);
        ...
        SendSnsDirectMessageAllPlanResultDto resultDto06 = saveSnsDirectMessageSendingResult2025Logic
        ...
        // 再送信5回目
        List<SendAlertSnsMessage2025Entity> list06 = sendAlertSnsMessage2025Repository
                .findBySaishinKbnAndSendAlertSnsMessageCodeOrderBySendAlertSnsMessageId(saishin, code);
