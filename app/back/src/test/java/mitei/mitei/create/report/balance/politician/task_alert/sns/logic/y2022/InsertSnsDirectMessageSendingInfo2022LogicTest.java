...
class InsertSnsDirectMessageSendingInfo2022LogicTest {
    ...
    @Test
    @Transactional
    @Sql("truncate_alert_sns_message_2022.sql")
    void testPractice() { // NOPMD
        ...
        int size = insertSnsDirectMessageSendingInfo2022Logic.practice(privilegeDto, listUser, shori, listTask);
        ...
        assertThat(result00.getDatetimeTimes1()).isEqualTo(LocalDateTime.of(2022, 7, 1, 5, 0, 0));
        assertThat(result00.getDatetimeTimes2()).isEqualTo(LocalDateTime.of(2022, 7, 1, 8, 0, 0));
        assertThat(result00.getDatetimeTimes3()).isEqualTo(LocalDateTime.of(2022, 7, 1, 14, 0, 0));
        assertThat(result00.getDatetimeTimes4()).isEqualTo(LocalDateTime.of(2022, 7, 2, 2, 0, 0));
        assertThat(result00.getDatetimeTimes5()).isEqualTo(LocalDateTime.of(2022, 7, 3, 2, 0, 0));
        ...
        // 2件目
        SendAlertSnsMessage2022Entity result01 = list.get(1);
        ...
        assertThat(result01.getDatetimeTimes1()).isEqualTo(LocalDateTime.of(2022, 7, 1, 5, 0, 0));
        assertThat(result01.getDatetimeTimes2()).isEqualTo(LocalDateTime.of(2022, 7, 1, 8, 0, 0));
        assertThat(result01.getDatetimeTimes3()).isEqualTo(LocalDateTime.of(2022, 7, 1, 14, 0, 0));
        assertThat(result01.getDatetimeTimes4()).isEqualTo(LocalDateTime.of(2022, 7, 2, 2, 0, 0));
        assertThat(result01.getDatetimeTimes5()).isEqualTo(LocalDateTime.of(2022, 7, 3, 2, 0, 0));
        ...
        // 3件目
        SendAlertSnsMessage2022Entity result02 = list.get(2);
        ...
        assertThat(result02.getDatetimeTimes1()).isEqualTo(LocalDateTime.of(2022, 7, 1, 5, 0, 0));
        assertThat(result02.getDatetimeTimes2()).isEqualTo(LocalDateTime.of(2022, 7, 1, 8, 0, 0));
        assertThat(result02.getDatetimeTimes3()).isEqualTo(LocalDateTime.of(2022, 7, 1, 14, 0, 0));
        assertThat(result02.getDatetimeTimes4()).isEqualTo(LocalDateTime.of(2022, 7, 2, 2, 0, 0));
        assertThat(result02.getDatetimeTimes5()).isEqualTo(LocalDateTime.of(2022, 7, 3, 2, 0, 0));
        assertThat(result02.getBodyText())
                .isEqualTo("事務員 花子さん　http://localhost:9080/abcde-page/3939?id=300&code=200に移動してね!!");

        // 4件目
        SendAlertSnsMessage2022Entity result03 = list.get(3);
        ...
        assertThat(result03.getDatetimeTimes1()).isEqualTo(LocalDateTime.of(2022, 7, 1, 5, 0, 0));
        assertThat(result03.getDatetimeTimes2()).isEqualTo(LocalDateTime.of(2022, 7, 1, 8, 0, 0));
        assertThat(result03.getDatetimeTimes3()).isEqualTo(LocalDateTime.of(2022, 7, 1, 14, 0, 0));
        assertThat(result03.getDatetimeTimes4()).isEqualTo(LocalDateTime.of(2022, 7, 2, 2, 0, 0));
        assertThat(result03.getDatetimeTimes5()).isEqualTo(LocalDateTime.of(2022, 7, 3, 2, 0, 0));
