...
class CsvWriteBatchLauncherTest {
// CHECKSTYLE:OFF
    /** テスト対象 */
    @Autowired
    private CsvWriteBatchLauncher csvWriteBatchLauncher;
    ...
    void testLaunchJob()throws Exception {
        ...
        // テスト対象のクラス.メソッド名
        final String taskName = "CsvWriteBatchLauncher.launchJob";
        ...
        if (scheduledTask.getTask() instanceof CronTask) {
            ...
            String expression = csvWriteBatchLauncher.getClass().getMethod("launchJob")
