...
import mitei.mitei.create.report.balance.politician.entity.task_plan.TaskPlan2025Entity;
import mitei.mitei.create.report.balance.politician.repository.task_plan.TaskPlan2025Repository;
...
class InsertTaskPlanY2025LogicTest {
    ...
    void testPractice() {
        ...
        int size = insertTaskPlanY2025Logic.practice(privilegeDto, listTask, listUser);
        ...
        // 1件目
        TaskPlan2025Entity result01 = list.get(0);
        ...
        // 2件目
        TaskPlan2025Entity result02 = list.get(1);
