...
/**
 * CallMailSendingInfo2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class CallMailSendingInfo2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() {
        ...
        SendMailCapsuleDto capsuleDto = callMailSendingInfo2024Logic.practice(localDateTime);
