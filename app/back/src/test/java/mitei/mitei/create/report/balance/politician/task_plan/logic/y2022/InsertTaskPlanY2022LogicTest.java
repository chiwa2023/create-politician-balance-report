...
class InsertTaskPlanY2022LogicTest {
    ...
    void testPractice() {
        ...
        int size = insertTaskPlanY2022Logic.practice(privilegeDto, listTask, listUser);

        assertThat(size).isEqualTo(2);

        List<TaskPlan2022Entity> list = taskPlan2022Repository.findAll();
        list.sort((e1, e2) -> e1.getTaskPlanCode() - e2.getTaskPlanCode());

        // 1件目
        TaskPlan2022Entity result01 = list.get(0);
        ...
        // 2件目
        TaskPlan2022Entity result02 = list.get(1);
