...
class AuditOpinionOutcome2025RepositoryTest {
    ...
    void testFindFullText() {
        // //全リスト
        // List<AuditOpinionOutcome2025Entity> listAll =
        // auditOpinionOutcome2025Repository.findAll();
        // //指定検索語で検索
        // List<AuditOpinionOutcome2025Entity> listCondition =
        // auditOpinionOutcome2025Repository.findFullText("");
        //
        ...
        // List<AuditOpinionOutcome2025Entity> listZero =
        // auditOpinionOutcome2025Repository.findFullText("あかさたな");
        // assertThat(listZero.size()).isEqualTo(0);
        //
        // //指定検索語でなし時は全件検索
        // List<AuditOpinionOutcome2025Entity> listNoWords =
        // auditOpinionOutcome2025Repository.findFullText("");
