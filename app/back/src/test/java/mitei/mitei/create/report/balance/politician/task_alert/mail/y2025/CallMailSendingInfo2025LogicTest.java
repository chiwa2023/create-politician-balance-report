...
/**
 * CallMailSendingInfo2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class CallMailSendingInfo2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() {
        ...
        SendMailCapsuleDto capsuleDto = callMailSendingInfo2025Logic.practice(localDateTime);
