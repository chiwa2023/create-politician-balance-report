...
/**
 * SaveSnsDirectMessageSendingResult2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SaveSnsDirectMessageSendingResult2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Transactional
    @Sql("save_alert_sns_message_2022.sql")
    void testPractice() { // NOPMD
        ...
        SendSnsDirectMessageAllPlanResultDto resultDto01 = saveSnsDirectMessageSendingResult2022Logic
                .practice(listResult01);
        ...
        List<SendAlertSnsMessage2022Entity> list01 = sendAlertSnsMessage2022Repository
                .findBySaishinKbnAndSendAlertSnsMessageCodeOrderBySendAlertSnsMessageId(saishin, code);
        assertThat(list01.size()).isEqualTo(1);
        SendAlertSnsMessage2022Entity entity01 = list01.get(0);
        ...
        SendSnsDirectMessageAllPlanResultDto resultDto02 = saveSnsDirectMessageSendingResult2022Logic
                .practice(listResult02);
        ...
        // 再送信2回目
        List<SendAlertSnsMessage2022Entity> list02 = sendAlertSnsMessage2022Repository
                .findBySaishinKbnAndSendAlertSnsMessageCodeOrderBySendAlertSnsMessageId(saishin, code);
        assertThat(list02.size()).isEqualTo(1);
        SendAlertSnsMessage2022Entity entity02 = list02.get(0);
        ...
        SendSnsDirectMessageAllPlanResultDto resultDto03 = saveSnsDirectMessageSendingResult2022Logic
                .practice(listResult03);
        ...
        // 再送信3回目
        List<SendAlertSnsMessage2022Entity> list03 = sendAlertSnsMessage2022Repository
                .findBySaishinKbnAndSendAlertSnsMessageCodeOrderBySendAlertSnsMessageId(saishin, code);
        assertThat(list03.size()).isEqualTo(1);
        SendAlertSnsMessage2022Entity entity03 = list03.get(0);
        ...
        SendSnsDirectMessageAllPlanResultDto resultDto04 = saveSnsDirectMessageSendingResult2022Logic
                .practice(listResult04);
        ...
        // 再送信4回目
        List<SendAlertSnsMessage2022Entity> list04 = sendAlertSnsMessage2022Repository
                .findBySaishinKbnAndSendAlertSnsMessageCodeOrderBySendAlertSnsMessageId(saishin, code);
        assertThat(list04.size()).isEqualTo(1);
        SendAlertSnsMessage2022Entity entity04 = list04.get(0);
        ...
        SendSnsDirectMessageAllPlanResultDto resultDto05 = saveSnsDirectMessageSendingResult2022Logic
                .practice(listResult05);
        ...
        // 再送信5回目
        List<SendAlertSnsMessage2022Entity> list05 = sendAlertSnsMessage2022Repository
                .findBySaishinKbnAndSendAlertSnsMessageCodeOrderBySendAlertSnsMessageId(saishin, code);
        assertThat(list05.size()).isEqualTo(1);
        SendAlertSnsMessage2022Entity entity05 = list05.get(0);
        ...
        SendSnsDirectMessageAllPlanResultDto resultDto06 = saveSnsDirectMessageSendingResult2022Logic
                .practice(listResult06);
        ...
        // 再送信5回目
        List<SendAlertSnsMessage2022Entity> list06 = sendAlertSnsMessage2022Repository
                .findBySaishinKbnAndSendAlertSnsMessageCodeOrderBySendAlertSnsMessageId(saishin, code);
