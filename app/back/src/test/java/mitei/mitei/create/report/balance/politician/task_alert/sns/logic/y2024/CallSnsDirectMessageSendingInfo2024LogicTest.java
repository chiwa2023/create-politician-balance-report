...
/**
 * CallSnsDirectMessageSendingInfo2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class CallSnsDirectMessageSendingInfo2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() {
        ...
        SendSnsDirectMessageCapsuleDto capsuleDto = callSnsDirectMessageSendingInfo2024Logic.practice(shori);
