...
/**
 * CallMailSendingInfo2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class CallMailSendingInfo2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() {
        ...
        SendMailCapsuleDto capsuleDto = callMailSendingInfo2022Logic.practice(localDateTime);
