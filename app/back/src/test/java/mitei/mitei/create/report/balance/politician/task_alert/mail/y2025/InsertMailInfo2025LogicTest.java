...
class InsertMailInfo2025LogicTest {
    ...
    @Test
    @Transactional
    @Sql("truncate_alert_mail_2025.sql")
    void testPractice() { // NOPMD
        ...
        int size = insertMailInfo2025Logic.practice(privilegeDto, shori, user00, listUser, listTask);
        assertThat(size).isEqualTo(4); // 2×2の4件

        List<SendAlertMail2025Entity> list = sendAlertMail2025Repository.findAll();
        list.sort((e1, e2) -> e1.getSendAlertMailCode() - e1.getSendAlertMailCode());

        // 1件目
        SendAlertMail2025Entity result00 = list.get(0);
        ...
        // 2件目
        SendAlertMail2025Entity result01 = list.get(1);
        ...
        // 3件目
        SendAlertMail2025Entity result02 = list.get(2);
        ...
        // 4件目
        SendAlertMail2025Entity result03 = list.get(3);
