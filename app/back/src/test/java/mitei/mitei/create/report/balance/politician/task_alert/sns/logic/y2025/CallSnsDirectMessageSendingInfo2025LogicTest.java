...
/**
 * CallSnsDirectMessageSendingInfo2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class CallSnsDirectMessageSendingInfo2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() {
        // 本来はシステム日付の年テーブルの処理
        LocalDateTime shori = LocalDateTime.of(2025, 11, 1, 0, 0, 0);

        SendSnsDirectMessageCapsuleDto capsuleDto = callSnsDirectMessageSendingInfo2025Logic.practice(shori);
