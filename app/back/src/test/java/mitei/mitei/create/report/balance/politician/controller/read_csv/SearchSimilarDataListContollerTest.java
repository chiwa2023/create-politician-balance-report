...
class SearchSimilarDataListContollerTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() throws Exception {
        ...
        Optional<ProposeCsvReadTemplateEntity> optional = proposeCsvReadTemplateRepository.findById(14L);
        ...
        //        .perform(post("/propose-csv-read/search-similar")
