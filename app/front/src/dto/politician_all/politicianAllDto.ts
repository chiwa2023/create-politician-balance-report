export default interface PoliticianAllInterface {
    /** 政治家Id */
...
export default class PoliticianAllDto implements PoliticianAllInterface {
    /** 政治家Id */
    politicianAllId: number;
     ...
     */
    constructor(impl?: PoliticianAllInterface) {
