...
export default class SessionStorageCommonCheck {
    ...
    static getPrivilege(): CheckPrivilegeDto {
        ...
        if (checkPrivilegeDtoJsonText !== null) {
            ...
            if ("politicalOrganizationId" in obj) {
                sessionPrivilegeDto.politicalOrganizationId = obj.politicalOrganizationId;
            }
            if ("politicalOrganizationCode" in obj) {
                sessionPrivilegeDto.politicalOrganizationCode = obj.politicalOrganizationCode;
            }
            if ("politicalOrganizationName" in obj) {
                sessionPrivilegeDto.politicalOrganizationName = obj.politicalOrganizationName;
            }
        }
