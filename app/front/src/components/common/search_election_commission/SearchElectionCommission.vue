...
import SearchElectionCommissionLeastCapsuleDto from "../../../dto/election_commission/searchElectionCommissionCapsuleDto";
...
async function onSearch() {
    ...
    searchElectionCommissionLeastCapsuleDto.checkTransactionDto = createCheckTransactionDto(!props.isEditable);

    //独自変数設定
    searchElectionCommissionLeastCapsuleDto.searchWords = searchWords.value;
